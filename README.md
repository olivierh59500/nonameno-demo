...
Port Go/Ebitengine d’une démo NONAMENO initialement réalisée avec le framework
JavaScript CODEF. Le projet cible macOS/desktop et Android `arm64-v8a` avec le
même moteur de jeu.
...
- plateforme originale : Web/CODEF ;
- port Go : ce dépôt.
