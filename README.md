...
A faithful Go/Ebiten port of one of NONAMENO demo originally created using the CODEF JavaScript framework. This implementation recreates the iconic scrolling text effects, 3D starfield, and animated letter transitions while maintaining the nostalgic feel of the original Atari ST demo scene.
...
- Character mapping follows the original CODEF demo layout
