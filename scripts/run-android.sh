...
# Keep the preserved original as the default; --dck builds its separate adapter.
...
echo "→ Lancement de NONAMENO Demo"
"$adb_path" shell am force-stop com.olivierh.nonameno
"$adb_path" shell am start -n com.olivierh.nonameno/.MainActivity
